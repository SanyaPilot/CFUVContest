...
class Bigint {
    public:
        ...
        // которые я испытал сегодня, моя жизнь поломана навсегда...
        ...
        // Я не знаю, почему это работает, все мои предыдущие попытки написать что-то стоящее закончились провалом
        // Украл отсюда, уже не вдумываясь https://www.geeksforgeeks.org/bigint-big-integers-in-c-with-example/
        Bigint operator/(Bigint b) {
